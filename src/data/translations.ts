...
export const translations = {
  en: {
    ...
    admin: {
      ...
      addLeadSubmit: 'Add lead & create follow-ups',
      ...
      claimPrompt: 'Claim this lead to assign it to yourself and set status to Contacted.',
      claimLead: 'Claim lead & create follow-ups',
      claiming: 'Claiming…',
      phone: 'Phone',
  ...
  lt: {
    ...
    admin: {
      ...
      addLeadSubmit: 'Pridėti potencialų klientą ir sukurti pasekimo užduotis',
      ...
      claimPrompt: 'Perimkite šį potencialų klientą, kad priskirtumėte jį sau ir nustatytumėte būseną „Susisiekta“.',
      claimLead: 'Perimti potencialų klientą ir sukurti pasekimo užduotis',
      claiming: 'Perimama…',
      phone: 'Telefonas',
